    public class Planet {
        ...
        public Planet(String nombre, int cantidadSatelites, double masa, double volumen, double diametro, double distanciaSol, boolean esObservable) {
            this.nombre = nombre;
        ...
        public static void main(String[] args) {
            Planet p1 = new Planet("Tierra", 1, 5.9736E24, 1.08321E12, 12742, 150000000, true);
            Planet p2 = new Planet("Jupiter", 1, 1.899E27, 1.4313E15, 139820, 750000000, true);
